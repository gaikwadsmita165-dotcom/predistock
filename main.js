const featuresList = [
  {
    ...
    title: "Integration with Stock Data",
    description:
      "Allow users to integrate specific stocks directly from the stock prediction platform.",
  },

  {
    icon: "images/reminders-icon.svg",
    title: "Market Condition Alerts",
    description:
      "Stay ahead with real-time alerts on shifting market conditions.",
  },
...

  {
    ...
    description:
      "Visualize stock performance and identify trends with interactive technical analysis charts.",
  },

  {
    ...
    description:
    "Gain insights into market trends and stock movements through real-time data analysis.",
  },

  {
    ...
    title: "Stock Info",
    description:
    "Get concise stock data and insights for informed decision-making.",
  },
];
...
const testimonialsList = [
  {
    ...
    name: "John Smith",
    designation: "Tech Lead, PrediStock",
  },
  {
    review:
    ...
    name: "Sarah Johnson",
    designation: "Product Manager, PrediStock",
  },
  {
    review:
    ...
    name: "Emily Davis",
    designation: "Project Manager, PrediStock",
  },
];
